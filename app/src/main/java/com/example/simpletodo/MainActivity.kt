...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // findViewById<Button>(R.id.button).setOnClickListener{//
            //Code in here is going to be execyted when the user clicks on a button}
        ...
        //Set up the button and input field, sp that the user can enter a task and add it to the list
